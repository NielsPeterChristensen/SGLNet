...
# Code from https://notebook.community/empet/Matplotlib-plots/Asymmetric-diverging-colormaps-in-matplotlib
...
def asymmetric_cmap(data, div_cmap='seismic', ref_point=0.0, name='asym_cmap'):
    '''
    Input
    -----
    ...
    '''
    if isinstance(div_cmap, str):
        div_cmap= plt.get_cmap(div_cmap)
    ...
    # matplotlib.colormaps.register(asym_cmap)      # Add to available colormaps
    # display_cmap(asym_cmap)                       # Display colormap
    # return D, asym_cmap, dmin, dmax               # Original return
    return asym_cmap